...
import { modelWorldMatrix, positionLocal, vec3, vec4, texture, vec2, float, inverse, modelWorldMatrixInverse } from "three/tsl";
...
export function TerrainPlane() {
    ...
    const { hf_size, width, height, hf_tex, hf_height } = useTerrain();
